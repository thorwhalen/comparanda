...
|---|---|---|---|
| [0001](0001-record-architecture-decisions.md) | Record architecture decisions | accepted | Nygard-format ADRs, immutable once accepted; change direction with a new file, never a quiet edit. ADRs 0002–0029 are all pre-implementation specification. |
...
| # | Title | Status | Decides |
|---|---|---|---|
| [0011](0011-collaboration.md) | Collaboration — annotations, multi-rater values, and disagreement as a finding | accepted | Annotations anchor to stable opaque ids at every scope; every rater assertion is retained and declares its `independence`; deleting a criterion never deletes the argument about whether it should exist. |
