...
export const AGREEMENT_ASSUMPTIONS: readonly [string, ...string[]] = Object.freeze([
  ...
  "Personas of one principal are not independent raters: a unit they both scored is labelled consistency, not agreement.",
